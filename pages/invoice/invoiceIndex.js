...
const InvoiceIndex = () => {
  ...
  return (
    <div className="container  w-lg-50  py-4 p-lg-5 overflow-auto bg-light  shadow rounded-3 ">
      <p className="text-center fs-4 fw-bold pb-2"> Save Your Information</p>
      <div className="row   gx-0 align-items-center justify-content-center">
        <div className="card col-9 ">
          <div className="card-header">Event Details</div>
          <div className="card-body">
            <h5 className="card-title">Evet Name: Holiday Consert</h5>
            <p className="card-text">Event location: Addis Abeba, Hilton</p>
